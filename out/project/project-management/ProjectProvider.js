...
class ProjectProvider {
    _extensionUri;
    context;
    static viewType = 'yonbip.project';
    _view;
    projectService;
    constructor(_extensionUri, context) {
        this._extensionUri = _extensionUri;
        this.context = context;
        this.projectService = new ProjectService_1.ProjectService(context);
    }
    ...
    async handleExportPatch(selectedPath) {
        try {
