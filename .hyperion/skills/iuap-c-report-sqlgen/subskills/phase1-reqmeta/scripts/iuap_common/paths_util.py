...
# 目录结构: iuap-c-report-sqlgen/subskills/phase1-reqmeta/scripts/iuap_common/paths_util.py
# 计算: paths_util.py → iuap_common → scripts → phase1-reqmeta → subs → iuap-c-report-sqlgen
