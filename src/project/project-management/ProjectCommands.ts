...
<module name="${dirName}">
     ...
     * @returns 用户是否确认
     */
    private async showCustomConfirmationDialog(title: string, message: string): Promise<boolean> {
     ...
     * @returns HTML字符串
     */
    private getConfirmationDialogHtml(title: string, message: string): string {
        // 将换行符转换为HTML段落
