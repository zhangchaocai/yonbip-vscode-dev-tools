...
### ✨  修改功能
- **修改功能**
  - 达梦数据库测试连接改为三段式探测（TCP端口 + disql凭据验证 + V$DATABASE.STATUS$ 库状态校验），移除 dmdb Node 驱动依赖，解决 DM8 SM4 国密加密协商不支持的问题
...
- **修改功能**
  - 增加旗舰版领域业务接口的MCP工具
  - 将报表单独拆分为一个独立的服务端点/mcp/sse/ultimate/report
...
### ✨  修改功能
- **修改功能**
  - 优化旗舰版使用IYmsJdbcApi没有加上Schema的问题
  - 支持V3_R5版本配置信息下载
...
### ✨  修改功能
- **修改功能**
  - 高级版初始化工程，添加扫描home/external/classes到classpath中
  - 修改高级版启动MCP连不上数据库的问题
...
- **问题修复**
  - MCP服务增加旗舰版配置信息
  - 更新MCP内置服务适配动态获取旗舰版配置

## [2.1.25] - 2026-01-06
### ✨  修改功能
- **问题修复**
  - 修改SQL Server 数据库连接问题
  - 修改其余细微问题
...
- **问题修复**
  - 修改报错乱码的问题
  - 修改月份乱码问题
  - 修改JDK1.8对临时生成的classpath文件不支持的问题，改用自定义类加载器进行加载

## [2.1.18] - 2025-12-19
### ✨  修改功能
- **问题修复**
  - 修复window电脑上全部加入源码的功能问题
